...
var $tbody = document.querySelector("datetime");
var $stateInput = document.querySelector("#city");
var $cityInput = document.querySelector("#state");
var $searchBtn = document.querySelector("#country");
var $searchBtn = document.querySelector("#shape");
var $searchBtn = document.querySelector("#comments");
var $searchBtn = document.querySelector("#durationMinutes");
